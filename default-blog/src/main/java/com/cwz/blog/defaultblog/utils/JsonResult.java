...
public class JsonResult {
    ...
    private static final String DEFAULT_DATA_CODE = "code";
    ...
    private static JsonData build(String key, Object value) {
        JsonData jsonData = new JsonResult().new JsonData(4);
    ...
    public static JsonData build(DataMap dataMap) {
        ...
        if (dataMap.getCode() != null) {
            jsonData.put(DEFAULT_DATA_CODE, dataMap.getCode());
        }
        return jsonData;
    }
