$(function () {
    ...
    var auth_code_warn1 = $("#auth_code_warn1");
    ...
    auth_code.focus(function () {
        ...
        auth_code_warn1.css("display","none");
    });
    username.focus(function () {
    ...
    function putIn() {
        ...
        var register_success_img = $('<div class="register_success_img">\n' +
            '            <img src="img/general/register.gif" class="am-img-thumbnail">\n' +
            '        </div>');
        sec.append(register_success_img);

        var register_success_words = $('<div class="register_success_words">\n' +
            '            <img src="img/general/register_icon.png">\n' +
            '            <p>恭喜注册成功，快去登录吧</p>\n' +
            '        </div>');
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data['status'] === 902){
                        ...
                        auth_code_warn1.css("display","block");
                        auth_code_error.css("display","block");
